...
<head>
    ...
    <style>
        ...
        .element-container.register {
            position: relative;
            background: url(/website/img/7.jpg) center top no-repeat;
...
<div class="w-100 element-container register">
    ...
    <div class="element-content">
        <h1 style="font-size: 70px;color : #fff"><span style="color : #cb1313">وارد</span> اکانت خود شوید</h1>
    </div>
</div>
<div class="d-flex flex-wrap align-items-center">
    <div class="form-box col-lg-7 col-md-8 col-12 mb-5">
        <h1 class="text-center mb-0">اطلاعات خود را وارد کنید</h1>
        <form class="w-100 p-4" method="post" action="{{ route('website.users.check') }}">
            {{ csrf_field() }}
            <div class="d-flex flex-wrap flex-md-row-reverse flex-column">
                ...
                <div class="col-12 my-md-3">
                    <div class="form-group">
                        <input type="submit" class="btn btn-darker btn-block" value="ورود">
                    </div>
                </div>
            </div>
        </form>
    ...
    <div class="col-lg-5 col-md-4 col-12 text-center">
        <p>قبلا ثبت نام نکرده اید ؟
            <a href="{{ route('website.users.join') }}">ثبت نام کنید</a>
        </p>
    </div>
</div>
